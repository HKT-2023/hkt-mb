...
interface IRecommendMarketplace {
  isTrigger: boolean;
  setIsTrigger: TButtonAny<boolean>;
}

const RecommendMarketplace: React.FC<IRecommendMarketplace> = ({
  isTrigger,
  setIsTrigger,
}) => {
  ...
  >(listing.getListing, params.listingParams(true, coordinates), {
    isUseFocus: true,
  });
...
export default RecommendMarketplace;
